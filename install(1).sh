...
echo
echo -e "${NONE}"
echo "This script will support you to download the latest version of Yumi's dotfiles".
echo
while true; do
...
echo "Choosing the version won't matter, this is a placeholder. The same version will be installed as of now."
version=$(gum choose "main-release" "rolling-release")
if [ "$version" == "main-release" ] ;then
    wget -P ~/Downloads/ https://github.com/YumisWorld/dotfiles/archive/refs/heads/master.zip
    v="main"
